...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Base: fixed positioning with vertical centering
        "fixed top-[50%] z-50 translate-y-[-50%] border bg-background shadow-lg duration-200",
        // Mobile: position from edges, let browser calculate width
        "left-4 right-4",
        // Tablet+: centered with transform and max-width
      ...
      {...props}
    >
      {/* Inner wrapper with padding and scroll - ensures content respects boundaries */}
      <div className="flex flex-col gap-4 p-5 max-h-[85vh] overflow-y-auto overflow-x-hidden w-full">
        {children}
      </div>
