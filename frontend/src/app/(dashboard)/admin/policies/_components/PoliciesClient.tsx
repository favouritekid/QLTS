// src/app/(dashboard)/admin/policies/_components/PoliciesClient.tsx
"use client";
...
import type { PolicyStatistics } from "@/types/policy.types";

interface PoliciesClientProps {
  initialData?: PolicyStatistics;
}

export function PoliciesClient({ initialData }: PoliciesClientProps) {
  const [activeTab, setActiveTab] = useState("workflow");
  
  // ⚡ Use initialData from Server Component if available
  const { data: stats, isLoading: statsLoading } = usePolicyStatistics({ initialData });
