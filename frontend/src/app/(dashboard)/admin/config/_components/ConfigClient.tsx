// src/app/(dashboard)/admin/config/_components/ConfigClient.tsx
"use client";
...
function ConfigTable({ title, description, icon, endpoint, queryKey, initialData }: ConfigTableProps) {
  ...
  // ⚡ Fetch items with optional initialData
...
interface ConfigClientProps {
  initialData?: {
    degreeLevels?: ConfigItem[];
    offeringTypes?: ConfigItem[];
      ...
      <Tabs defaultValue="degree-levels" className="space-y-4">
        ...
        <TabsContent value="degree-levels">
          <ConfigTable
            ...
            initialData={initialData?.degreeLevels}
          />
        </TabsContent>
        ...
        <TabsContent value="offering-types">
          <ConfigTable
            ...
            initialData={initialData?.offeringTypes}
          />
        </TabsContent>
