...
|---|---|---|---|---|---|---|---|
| FE-zod-status | Zod 14 status enum + plural `admission_profiles` + typed `available_actions` (Stage 3 strict re-tighten sau khi BE M-1-11 + FE-badge + FE-tabs ship) | FE | **STAGE 1 SHIPPED** (permissive parse + 4 eligibility fields) — Stage 3 strict re-tighten TODO | Stage 1: [#211](https://github.com/favouritekid/QLTS/pull/211) merged squash `d9631ad5` (FE-zod-eligibility — permissive `z.union([z.enum legacy, z.string()])` + 4 eligibility fields parity với phase1_09a). | tsc:✓ vitest:✓ 18 (10 legacy + 3 unknown + non-string reject + 4 fields range/null/coerce + combined). | Stage 1 unblocks M-1-11 deploy choreography per PLAN line 3049-3055. Stage 3 strict 14-state lock + FE-badge + FE-tabs phải ship CÙNG/TRƯỚC M-1-11 final (Wave 3 wave bundle). | PLAN §4 Phase 3 FE #1 + RISK_REVIEW P1-01 |
