...
**Last updated:** 2026-05-03 (B2.4 / T0-4b merged via [#200](https://github.com/favouritekid/QLTS/pull/200) squash `737eb1bc` — real claim/dispatch/finalize outbox worker replaces T0-4a skeleton. Post-merge full notification regression on parent `737eb1bc`: 177 passed + 1 skipped (58.95s). Coverage invariant unchanged: 0 raw-dispatch-of-outbox-event violations, 12 expected no-dispatch-site gaps until #16, 7 outbox events tracked. Alembic head unchanged `phase1_19a`. B2 code gate is now TESTED; issue #183 B2 checkbox ticked. NEXT = B1 Casbin deny-first; #16 remains blocked until B1 + B2 are both TESTED.)
