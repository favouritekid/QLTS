...
| M-1-archive-profile | `phase1_16_create_archived_admission_profile_table` (PATCH-20; 90-day archive policy + round end_date+6m archive cron); ship-order Wave 5-D (next after Wave 5-A phase1_19c) | BE | TODO | | M:- | (none — depends only on Wave 1 admission_profile schema ✅) | PLAN §7.5 archive + §8 line 4491 slot assignment |
