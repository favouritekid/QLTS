...
| M-1-archive-profile | `phase1_16_create_archived_admission_profile_table` (PATCH-20; 90-day archive policy + round end_date+6m archive cron) | BE | TODO | | M:- | | PLAN §7.5 archive + §8 line 4491 slot assignment |
| M-1-archive-outbox | `phase1_17_create_archived_outbox_table` (PATCH-20; table `_archived_notification_outbox` chứa cả dispatched + failed sau 90d, KHÔNG chỉ failed per Phần 1 #08 fix line 168-178) | BE | TODO | | M:- | | PLAN §3.3.e archive + §8 line 4492 slot assignment |
...
| M-1-19d | `phase1_19d_register_celery_beat_archive_task` (renamed từ spec 19c; cùng task T0-4 — `dispatch_pending_outbox` 10s + `archive_outbox_dispatched_task` weekly 90d) | BE | TODO | | M:- I:- | T0-4 ship cùng; M-1-19c TESTED ✓ | PLAN §4 P1 #19d (post-cascade) |
| M-1-19e | `phase1_19e_seed_notification_rules` (renamed từ spec 19d; channel routing rule rows per audience từng event — Zalo/email/in-app) | BE | TODO | | M:- I:- | M-1-19a + M-1-19c | PLAN §4 P1 #19e (post-cascade) |
