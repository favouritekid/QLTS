...
| M-1-archive-outbox | `phase1_17_create_archived_outbox_table` (PATCH-20; table `_archived_notification_outbox` chứa cả dispatched + failed sau 90d, KHÔNG chỉ failed per Phần 1 #08 fix line 168-178); ship-order Wave 5-E (after Wave 5-D) | BE | TODO | | M:- | M-1-19a notification_outbox schema ✅ | PLAN §3.3.e archive + §8 line 4492 slot assignment |
