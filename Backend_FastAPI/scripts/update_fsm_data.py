...
CONSULTATION_STATUS_DATA = [
    ...
    {"id": "sts05", "code": "CALLBACK_LATER", "name": "Hẹn liên hệ lại", "phase": "consultation", "stage_id": "stg02", "status_type": "transition", "selectable_mode": "user", "outcome_type": "neutral", "is_final": False, "is_universal": False, "updates_pipeline": False, "counts_for_funnel": False, "description": "Hẹn gọi lại"},
    {"id": "sts06", "code": "CONSULT_ACCEPTED", "name": "Đồng ý tư vấn", "phase": "consultation", "stage_id": "stg02", "status_type": "transition", "selectable_mode": "user", "outcome_type": "positive", "is_final": False, "is_universal": False, "updates_pipeline": False, "counts_for_funnel": True, "description": "Đồng ý bước tư vấn"},
