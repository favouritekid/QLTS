...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('user_agent', sa.Text(), nullable=True),  # Lấy từ 20250103 (tốt hơn String(512))
    ...
    op.create_index(op.f('ix_user_session_created_at'), 'user_session', ['created_at'], unique=False)
    op.create_index(op.f('ix_user_session_last_activity_at'), 'user_session', ['last_activity_at'], unique=False)
