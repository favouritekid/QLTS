...
BUSINESS_GAP_ROWS = [
    ...
    [
        ...
        "reject_payment() dispatches PAYMENT_REJECTED post-commit.",
        "Active — curated template seeded via sync_notification_rules.",
        "yes",
        "no",
        "no",
        "small",
...
async def build_workbook(output_path: Path) -> None:
    ...
    allowed_zns_events = {"payment_verified", "application_status_changed", "consultation_reminder", "lead_created", "invoice_issued"}
        ...
        intake_rows.append(
            {
                ...
                "recipient_primary": "lead_contact" if event_key in {"payment_verified", "application_status_changed", "consultation_reminder", "lead_created", "invoice_issued"} else "collaborator_user",
                "recipient_additional": "",
