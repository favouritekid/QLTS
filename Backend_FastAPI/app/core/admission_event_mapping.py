...
ADMISSION_EVENT_PROJECTIONS = {
    ...
    "lead_created": AdmissionEventProjection(
        ...
        consultation_name="Chưa liên hệ",
    ...
    "profile_approved": AdmissionEventProjection(
        ...
        consultation_name="Chờ đóng học phí",
    ...
    "profile_confirmed": AdmissionEventProjection(
        ...
        consultation_status_id="sts09",  # Stay at "Chờ đóng học phí"
        consultation_name="Chờ đóng học phí",
    ...
    "fee_recorded": AdmissionEventProjection(
        ...
        consultation_name="Đã nộp học phí",
    ...
    "profile_rejected": AdmissionEventProjection(
        ...
        consultation_status_id="sts16",  # ✅ "Yêu cầu bổ sung" (Stage 3)
        consultation_name="Yêu cầu bổ sung",
        pipeline_stage_id="stg03",  # Stay in "Đã nộp hồ sơ"
        stage_name="Đã nộp hồ sơ",
        system_note_template="[HỆ THỐNG] Hồ sơ yêu cầu bổ sung/chỉnh sửa - Profile #{profile_id}. Lý do: {reason}",
        skip_if_converted=True,
    ),
    ...
    "student_refunded": AdmissionEventProjection(
        ...
        consultation_name="Đã rút lại học phí",
        pipeline_stage_id="stg07",
        stage_name="Không đi học",
        system_note_template="[HỆ THỐNG] Học viên rút lại học phí - Profile #{profile_id}",
        skip_if_converted=True,
    ),
}
