...
# refactor (2026-04-22). The pre_status + commission contracts they
# guarded migrated from the router into the service (composed into a
# single post-commit callback via `dispatch_bundle` + commission closure).
# Service-level coverage now lives in tests/services/test_admission_service.py
# and tests/services/test_notification_bundle.py.
